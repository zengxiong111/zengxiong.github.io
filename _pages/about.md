...
**Xiong Zeng**, Laurent Bako, and Necmiye Ozay. IEEE Transactions on Automatic Control (**TAC**) 2025.
 ...
 [System Identification Under Bounded Noise: Optimal Rates Beyond Least Squares](https://arxiv.org/abs/2503.16817)[<a href="https://github.com/jy-cds/Bounded-Noise-SysID-Minimax-Lowerbound" style="color: blue;" target="_blank">code</a>]
 [<a href="https://zengxiong111.github.io/zengxiong.github.io/files/Poster_system_id_bounded_noise.pdf"
   target="_blank"
   style="color: blue;">
poster
</a>]<br>
...
Graduate Instructor for EECS 501 **Probability Theory and Random Process** (Fall 2024)<br>
&nbsp;
## Other Writings
...
<a href="https://lavalle.pl/bio.html" style="color: blue;" target="_blank">Story of Prof. Steven M. LaValle</a>, the inventor of rapidly exploring random tree (RRT).
...
>>>>>>> 89dac9316f4ec1b5611a9490395b37bbfdede224

Core theme: **Real2Sim2Real = System Identification + Learning-based Control**.

For a detailed overview, see [my PhD proposal slides](https://github.com/zengxiong111/zengxiong.github.io/releases/download/v1.0/phd_propsoal_Xiong_Zeng_part.pdf).
...
- [Other writings and useful links](/resources/)
- [Bio and running](/markdown/)
- [CV](/cv/)
